...
export default class QueueHandler {
    ...
    static progress() {
        ...
        if (
            QueueHandler.generalQueue.isEmpty() &&
            QueueHandler.leftQueue.isEmpty() &&
            QueueHandler.rightQueue.isEmpty()
        ) {
     ...
     * @param {('left'|'right')} [element.preferredSide]
     * @returns {void}
     */
    static add(element) {
    ...
    /**
     * @param {string} element the 'name' of the data
     * @returns {void}
     */
    ...
    static _removeFromOnscreen(onscreen, element) {
        if (onscreen.M1 == element) {
            onscreen.M1 = undefined;
        } else if (onscreen.M2 == element) {
            onscreen.M2 = undefined;
        } else if (onscreen.T1 == element) {
            onscreen.T1 = undefined;
        } else if (onscreen.T2 == element) {
            onscreen.T2 = undefined;
        }
    }
